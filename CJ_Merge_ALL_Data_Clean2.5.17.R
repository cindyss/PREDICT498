...
n_distinct(mobile.test$device_id) #17,278 as expected
...
#library(DataExplorer);
#GenerateReport(mobile.test, output_file = "cj_mobile.test_eda_report.html")
#men <- mobile.test[ which(mobile.test$gender=='M'),]
#women <- mobile.test[ which(mobile.test$gender=='F'),]
#head(men)
#summary(men)
#dim(men)
#head(women)
#summary(women)
#dim(women)
#GenerateReport(data.test, output_file = "td_eda_report.html")
#GenerateReport(men, output_file = "men_td_eda_report.html")
#GenerateReport(women, output_file = "women_td_eda_report.html")
names(mobile.test)
